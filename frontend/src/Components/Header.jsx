                            ...
                            authUser === null ? (
                                ...
                                <li className="nav-item dropdown pe-3">
                                    <a className='nav-link nav-profile d-flex align-items-center pe-0' href="/" data-bs-toggle="dropdown">
                                        ...
                                        <span className="d-none d-md-block dropdown-toggle ps-2">Welcome! {authUser.fullName}</span>
                                    </a>

                                    <ul className='dropdown-menu dropdown-menu-end dropdown-menu-arrow profile'>
                                        <li className='dropdown-header'>
                                            <h6><i class="bi bi-person-fill"></i>&nbsp;&nbsp;{authUser.fullName}</h6>
                                            <h6 style={{marginTop: "10px"}}><i class="bi bi-envelope"></i>&nbsp;&nbsp;{authUser.emailID}</h6>
                                            <h6 style={{marginTop: "10px"}}><i class="bi bi-building"></i>&nbsp;&nbsp;{authUser.occupation}</h6>
                                        </li>
